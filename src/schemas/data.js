export const Data = {
  profile: {
    ...
    ocupation: "React-native Developer",
  ...
  socialMedia: {
    ...
    social: [
      ...
      },
      {
        label: "Shah Prem",
        name: "twiiter",
        url: "https://twitter.com/Shahprem99",
  ...
  experience: {
    ...
    academic: [
      ...
      },
      {
        ...
        date: "2015-2017",
        institution: "Higher Secondary School Certificate",
        percent: "Percent: 71.84%",
      },
      {
        career:
          "Gujarat Secondary and Higher Secondary Education Board, Gandhinagar",
    ...
    projects: [
      ...
      },
      {
        ...
        description: [
          "App for Android to get analysis of chart and stocks. About Share Market profit and loss, buying and selling on Stocks, Get information of opening, Closing timing and holidays of Share Market. Worked on UI building in app. Navigation, API fetch and set data on every component to show data accordingly",
        ],
        link: [
          {
            android:
              "https://play.google.com/store/apps/details?id=breakout.stocks.india",
          },
        ],
      },
    ],
